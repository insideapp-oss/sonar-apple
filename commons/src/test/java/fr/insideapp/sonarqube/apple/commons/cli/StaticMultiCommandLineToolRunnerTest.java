...
public final class StaticMultiCommandLineToolRunnerTest {

    private StaticMultiCommandLineToolRunner runner;
    ...
    public void run_no_option() {
        ...
        when(runner.arguments()).thenReturn(options);
        // test
    ...
    private StaticMultiCommandLineToolRunner makeMock(String command) {
        return mock(
                StaticMultiCommandLineToolRunner.class,
