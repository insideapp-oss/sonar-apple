...
public final class OCLintSensor implements Sensor {
    ...
    public void execute(SensorContext sensorContext) {
        ...
        String compileCommands = compileCommandsBuilder.toString();
        Pattern pattern = Pattern.compile("(\"-index-store-path.*DataStore\", |\"-index-unit-output-path.*\\.o\", )");
        compileCommands = RegExUtils.removeAll(compileCommands, pattern);
