...
public class XcodeTestClassReport {
    ...
    public XcodeTestClassReport(XcodeTestGroup group) {
    ...
    private static EnumMap<Status, Integer> buildMap(List<XcodeTestCase> testCases) {
