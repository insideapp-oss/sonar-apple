...
import fr.insideapp.sonarqube.objc.tests.ObjectiveCLanguageTestFileFinder;
...
@ScannerSide
public class XcodeTestsExtensionProvider implements ExtensionProvider {

    public List<Object> extensions() {
        return Arrays.asList(
                XcodeTestsParser.class,
                XcodeTestsMapper.class,
                SwiftLanguageTestFileFinder.class,
                ObjectiveCLanguageTestFileFinder.class,
                XcodeTestFileFinder.class,
                XcodeTestsRecorder.class,
                XcodeTestsSensor.class
        );
    }
